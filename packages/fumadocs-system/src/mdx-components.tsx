...
import { ProjectArchitectureMapFigure } from "./components/project-architecture-map-figure";
...
export function getFumadocsSystemMDXComponents(components?: MDXComponents): MDXComponents {
  return {
    ...
    h1: ({ className, ...props }) => (
      <h1 className={cn("topoo-docs-page-title mt-2 scroll-m-28 font-semibold tracking-tight", className)} {...props} />
    ),
    h2: ({ className, children, id, ...props }) => (
      <h2
        className={cn(
          "topoo-docs-section-title mt-10 scroll-m-28 font-medium tracking-tight first:mt-0 lg:mt-12 [&+p]:mt-4! [&+ul]:mt-4! [&+ol]:mt-4!",
          className,
        )}
    ...
    h3: ({ className, ...props }) => (
      <h3 className={cn("topoo-docs-subsection-title mt-12 scroll-m-28 font-medium tracking-tight [&+p]:mt-4!", className)} {...props} />
    ),
    h4: ({ className, ...props }) => (
      <h4 className={cn("topoo-docs-body-title mt-8 scroll-m-28 font-medium tracking-tight", className)} {...props} />
    ),
    h5: ({ className, ...props }) => (
      <h5 className={cn("topoo-docs-body-title mt-8 scroll-m-28 font-medium tracking-tight", className)} {...props} />
    ),
    h6: ({ className, ...props }) => (
      <h6 className={cn("topoo-docs-body-title mt-8 scroll-m-28 font-medium tracking-tight", className)} {...props} />
    ),
    a: ({ className, ...props }) => (
    ...
    table: ({ className, ...props }) => (
      <div className="my-6 no-scrollbar w-full overflow-y-auto rounded-xl border">
        <table
          className={cn(
            "topoo-docs-body relative w-full overflow-hidden border-none [&_tbody_tr:last-child]:border-b-0",
            className,
          )}
          {...props}
        />
